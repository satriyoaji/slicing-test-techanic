        ...
        <div>
            <button className="inline-block z-40 fixed bg-yellow-400 w-auto bottom-10 right-14 shadow-xl p-3 rounded-full hover:bg-yellow-500" onClick={openCloseChat}>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M5 4C4.73478 4 4.48043 4.10536 4.29289 4.29289C4.10536 4.48043 4 4.73478 4 5V18.5858L6.29289 16.2929C6.48043 16.1054 6.73478 16 7 16H19C19.2652 16 19.5196 15.8946 19.7071 15.7071C19.8946 15.5196 20 15.2652 20 15V5C20 4.73478 19.8946 4.48043 19.7071 4.29289C19.5196 4.10536 19.2652 4 19 4H5ZM2.87868 2.87868C3.44129 2.31607 4.20435 2 5 2H19C19.7957 2 20.5587 2.31607 21.1213 2.87868C21.6839 3.44129 22 4.20435 22 5V15C22 15.7957 21.6839 16.5587 21.1213 17.1213C20.5587 17.6839 19.7957 18 19 18H7.41421L3.70711 21.7071C3.42111 21.9931 2.99099 22.0787 2.61732 21.9239C2.24364 21.7691 2 21.4045 2 21V5C2 4.20435 2.31607 3.44129 2.87868 2.87868Z" fill="#FFFFFF"/>
                </svg>
            </button>
            <div className={`${isOpen? 'visible' : 'hidden'} drop-shadow-xl inline-block fixed z-40 bg-white text-black md:w-[350px] bottom-10 right-32 h-5/6 rounded-lg overflow-hidden chatbot-sm`}>
                <div className={`chat-box`}>
                    <div className={` flex flex-row w-full bg-[#103968] items-center`}>
                        <p className="font-roboto text-lg text-white font-normal tracking-wide pl-5 py-3">Chatbot Start</p>
                    ...
                    <div className="animate__animated animated animate__fadeInUp" style={{duration: '0.8s'}}>
