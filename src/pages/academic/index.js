                                ...
                                return (
                                    <figure className="m-8">
                                        <div className="galeri">
                                            ...
                                            <div className="galeri-caption flex items-center tech-primary border-l-4 border-l-[#f2c808] border-solid mx-0 h-16 mt-[-30px] py-[10px] px-[15px] text-center z-[1] relative text-white">
